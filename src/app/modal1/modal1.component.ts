...
@Component({
  ...
  styles: [
    `
      ...
      .card-modal ::ng-deep mat-card-content,
      .card-modal ::ng-deep mat-card-title,
      .card-modal ::ng-deep mat-card-actions {
        padding-left: -5;
        margin-left: -5;
      }
    `,
...
export class Modal1Component implements OnInit{
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: any,private fb: FormBuilder, private docService: DocService
  ) {
